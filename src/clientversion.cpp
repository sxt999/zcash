...
#define CLIENT_VERSION_SUFFIX "LINE-85" //// this triggered for Bullseye
#elif defined(GIT_COMMIT_ID)
#define BUILD_DESC BUILD_DESC_FROM_COMMIT(CLIENT_VERSION_MAJOR, CLIENT_VERSION_MINOR, CLIENT_VERSION_REVISION, CLIENT_VERSION_BUILD, GIT_COMMIT_ID)
#define CLIENT_VERSION_SUFFIX "LINE-88"
#else
#define BUILD_DESC BUILD_DESC_FROM_UNKNOWN(CLIENT_VERSION_MAJOR, CLIENT_VERSION_MINOR, CLIENT_VERSION_REVISION, CLIENT_VERSION_BUILD)
#define CLIENT_VERSION_SUFFIX "LINE-91"
#endif
#endif

#pragma message ("CLIENT_VERSION_SUFFIX" CLIENT_VERSION_SUFFIX)
#pragma message ("BUILD_DESC" BUILD_DESC)
